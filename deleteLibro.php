...
<body background= "Imagenes/2.jpg">
	<div id="menu" class="barraInicio">
		...
		<div style="display: flex;">
			...
			<h2 class="tituloSecundarioConfiguracion" >Ingrese el ISBN del libro que desea eliminar</h2>
			...
			<?php 
				...
				if (!empty($_POST['ISBN'])){
					$sql= "SELECT ISBN FROM libro WHERE ISBN= '".$_POST['ISBN']."' ";
                    $result=mysqli_query($conexion,$sql);
                    $mostrar=mysqli_fetch_array($result);
					if( mysqli_num_rows($result) == 1 ){  
                            $sql="DELETE FROM libro WHERE '".$_POST['ISBN']."'=ISBN ";
					        $result=mysqli_query($conexion,$sql);
                    ...
                    echo "<font color=white  size='5pt'> Debe ingresar un ISBN para eliminar </font>";
