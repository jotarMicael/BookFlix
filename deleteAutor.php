...
<body background= "Imagenes/2.jpg">
	<div id="menu" class="barraInicio">
		...
		<div style="display: flex;">
			...
			<h2 class="tituloSecundarioConfiguracion" >Ingrese los datos del autor que quiere borrar</h2>
			...
			<?php 
				...
				if (!empty($_POST['nombreAutor'])&&!empty($_POST['apellidoAutor'])){
					...
					if( mysqli_num_rows($result) == 1 ){  
                            $sql= "DELETE FROM autor WHERE '".$_POST['nombreAutor']."'=nombre and '".$_POST['apellidoAutor']."'=apellido ";
					        $result=mysqli_query($conexion,$sql);
                    ...
                    echo "<font color=white  size='5pt'> Debe ingresar nombre y apellido del autor a borrar </font>";
