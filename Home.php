	...
	<div id="menu" class="barraInicio">
			...
			?>	
				...
				<div class="divLibrosRandom">
						<?php 
							$sql="SELECT imagenTapaLibro,nombre_Libro,autor,genero,id_Editorial from libro ";
							$result=mysqli_query($conexion,$sql);
							while($mostrar=mysqli_fetch_array($result)){
						?>
							<div class="divLibro">
								<a href="vistaPrevia.php?libro=<?php echo $mostrar['imagenTapaLibro'];?>&nombreLibro=<?php echo $mostrar['nombre_Libro'];?>&autor=<?php echo $mostrar['autor'];?>&genero=<?php echo $mostrar['genero'];?>&idEd=<?php echo $mostrar['id_Editorial'];?>"><image width="80%" src="/BookFlix/Portadas/<?php echo $mostrar['imagenTapaLibro'];?>"/></a><br><br>
								<br>
